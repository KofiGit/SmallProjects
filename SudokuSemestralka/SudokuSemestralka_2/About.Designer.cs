...
namespace SudokuSemestralka_2
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Sudoku Game - Semestral Work";
			// 
			// label3
			// 
			...
			this.label4.Text = "Petr Koukolicek";
			// 
			// label5
			// 
			...
			this.label5.Text = "2020/2021 AIK2";
			// 
			// About
			// 
			...
			this.MaximumSize = new System.Drawing.Size(334, 157);
			this.MinimumSize = new System.Drawing.Size(334, 157);
			this.Name = "About";
			this.Text = "About";
